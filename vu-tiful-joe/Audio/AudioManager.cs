...
namespace VideoPlayerController
{
	...
	public class AudioMeter {
		static IAudioMeterInformation Meter() {
			...
			IMMDevice dev = null;
			Marshal.ThrowExceptionForHR(enumerator.GetDefaultAudioEndpoint(EDataFlow.eRender, ERole.eMultimedia, out dev));
			object epv = null;
			var epvid = typeof(IAudioMeterInformation).GUID;
			Marshal.ThrowExceptionForHR(dev.Activate(ref epvid, /*CLSCTX_ALL*/ 23, IntPtr.Zero, out epv));
			return (IAudioMeterInformation)epv;
		}
